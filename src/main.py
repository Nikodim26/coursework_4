...
from src.utils import write_file, translate_text, obtaining_information_on_the_criteria, write_file_add
from src.write_add_del_ import WriteAddDel
...
def working_with_the_user() -> None:
    ...
    if response == "" or response.lower() == "да":
        ...
        for dt in airplanes_data:
            ...
            if airplane > airplane_max: airplane_max = airplane
